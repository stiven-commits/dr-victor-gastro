export default function MetricsCards({ loading, totalLeads, prospectsCount, activePatients }) {
  return (
    <div className="grid grid-cols-1 gap-6 mb-8 md:grid-cols-3">
      ...
      <div className="p-6 bg-white border-l-4 shadow-sm rounded-2xl border-orange-500">
        ...
        <p className="mt-2 text-3xl font-bold text-slate-800">{loading ? '-' : prospectsCount}</p>
      </div>
